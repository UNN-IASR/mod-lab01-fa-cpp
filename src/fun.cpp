...
unsigned int faStr3(const char* str) {
    ...
    if (wordCount == 0) return 0; // Для избежания деления на ноль
    return std::round(static_cast<double>(sumLength) / wordCount); // Возвращаем среднюю длину слова, округленную до целого
}
